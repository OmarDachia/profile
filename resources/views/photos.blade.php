...
<main class="main-container home-section">
    ...
    <section class="projects" id="select-projects">
        ...
        <div class="project-cards-container">
            ...
            <div class="card">
                <img src="{{ asset('img/project-preview/subuwu-preview.png')}}"
                    alt="Project Preview Screenshot" class="card-preview-img">
                <div class="card-info">
                    <div class="title-and-links">
                        <span class="project-title">
            ...
            <div class="card">
                <img src="{{ asset('img/project-preview/ig-bot-preview.png')}}"
                    alt="Project Preview Screenshot" class="card-preview-img">
                <div class="card-info">
                    <div class="title-and-links">
                        <span class="project-title">
            ...
            <div class="card">
                <img src="{{ asset('img/project-preview/twitcord-preview.png')}}"
                    alt="Project Preview Screenshot" class="card-preview-img">
                <div class="card-info">
                    <div class="title-and-links">
                        <span class="project-title">
